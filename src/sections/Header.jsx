...
//           <img src="/images/ccart.png" alt="logo" />
//         </a>
//         <div
//           className={clsx(
              ...
              <ul className="flex max-lg:block max-lg:px-12">
                <li className="nav-li">
                  <NavLink
                    ...
                    target={navItems[0].target}
                  />
                  <div className="dot" />
                  <NavLink
                    title={navItems[1].title}
                    target={navItems[1].target}
                  />
                </li>
                <li className="nav-logo">
                  <LinkScroll
                ...
                <li className="nav-li">
                  <NavLink
                    ...
                    target={navItems[2].target}
                  />
                  <div className="dot" />
                  <NavLink
                    title={navItems[3].title}
                    target={navItems[3].target}
                  />
                </li>
              </ul>
            </nav>
